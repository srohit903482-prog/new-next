        ...
        <header className="bg-soft-white border-b border-light-gray sticky top-0 z-50 shadow-sm backdrop-blur-lg bg-opacity-95">
            <div className="container mx-auto px-6 sm:px-2  py-4">
                <nav className="flex justify-between items-center">
                    ...
                    {/* Call Button */}
                    <a href="tel:9034821319" className="bg-gray-500 hover:bg-sky-400 text-white text-xs md:text-sm px-2 py-1.5 rounded-lg font-medium transition-all duration-300 shadow-md hover:shadow-lg">

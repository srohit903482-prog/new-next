    ...
    return (
        <main>
            ...
            <section className="relative bg-gradient-to-br from-soft-blue via-soft-white to-warm-gray overflow-hidden">
                ...
                <div className="relative container mx-auto px-6 py-20 md:py-32 text-center">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
                            ...
                            <div className="bg-white p-6 rounded-xl shadow-md card-shadow hover-lift text-center border-t-4 border-blue-600">
                                <div className="h-16 flex items-center justify-center mb-4">
                                    <Image src="/images/hp-logo.png" alt="HP" width={80} height={80} className="max-h-12 w-auto object-contain" />
                                </div>
                            ...
                            <div className="bg-white p-6 rounded-xl shadow-md card-shadow hover-lift text-center border-t-4 border-blue-800">
                                <div className="h-16 flex items-center justify-center mb-4">
                                    <Image src="/images/brother-logo.png" alt="Brother" width={100} height={100} className="max-h-12 w-auto object-contain" />
                                </div>
                            ...
                            <div className="bg-white p-6 rounded-xl shadow-md card-shadow hover-lift text-center border-t-4 border-red-600">
                                <div className="h-16 flex items-center justify-center mb-4">
                                    <Image src="/images/canon-logo.png" alt="Canon" width={100} height={100} className="max-h-12 w-auto object-contain" />
                                </div>
                        ...
                        {/* Browse Services */}
                        <Link href="#brands" className="inline-flex items-center gap-3 bg-professional-navy text-white px-8 py-4 rounded-lg font-semibold hover-lift floating-action">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="order-2 lg:order-2">
                            <div className="mb-8">
                                ...
                                <p className="text-lg text-medium-gray leading-relaxed">
                                    When remote solutions aren't enough, our certified technicians come to your location for comprehensive on-site diagnosis and repair. Professional, reliable service for all major printer brands.
                                </p>
                            </div>
                            {/* Features Grid */}
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            ...
            <section id="brands" className="section-padding bg-soft-white">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-professional-navy mb-4">Supported Printer Brands</h2>
                        <p className="text-lg text-medium-gray max-w-2xl mx-auto">Professional technical support for all major printer manufacturers</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden card-shadow brand-card-hover border border-light-gray">
                            ...
                            <div className="p-6">
                                <p className="text-medium-gray mb-6">Complete support for LaserJet, OfficeJet, DeskJet, and Envy series printers.</p>
                                <div className="space-y-3 mb-6">
                                    {["Driver installation & updates", "Wi-Fi & USB connectivity", "Print quality optimization"].map((item, i) => (
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden card-shadow brand-card-hover border border-light-gray">
                            <div className="p-8 bg-gradient-to-br from-warm-gray to-white flex flex-col items-center">
                                ...
                                <div className="relative w-64 h-48">
                                    <Image src="/images/brother-printer.png" alt="Brother Printer" fill className="object-contain" />
                                </div>
                            </div>
                            <div className="p-6">
                                <p className="text-medium-gray mb-6">Expert support for Brother all-in-ones, label makers, and business printers.</p>
                                <div className="space-y-3 mb-6">
                                    {["Scanner functionality issues", "Error code resolution", "Network configuration"].map((item, i) => (
                                        <div key={i} className="flex items-center text-sm">
                        ...
                        <div className="bg-white rounded-2xl overflow-hidden card-shadow brand-card-hover border border-light-gray">
                            ...
                            <div className="p-6">
                                <p className="text-medium-gray mb-6">Specialized support for PIXMA, imagePROGRAF, and SELPHY photo printers.</p>
                                <div className="space-y-3 mb-6">
            ...
            <section id="troubleshooting" className="section-padding bg-warm-gray">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-professional-navy mb-4">Common Printer Problems &amp; Solutions</h2>
                        <p className="text-lg text-medium-gray max-w-2xl mx-auto">Quick guides to resolve the most frequent printer issues</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {/* Connectivity Issues */}
                        <div className="bg-white rounded-2xl p-8 card-shadow hover-lift border border-light-gray">
                            <div className="bg-medium-blue text-white w-14 h-14 rounded-full flex items-center justify-center mb-6"><i className="fas fa-wifi text-xl"></i></div>
                            <h3 className="text-2xl font-bold text-professional-navy mb-4">Connectivity Issues</h3>
                            <p className="text-medium-gray mb-6">Wi-Fi, USB, or network connection problems? We provide step-by-step guides to restore your printer connection.</p>
                            <div className="space-y-3 mb-8">
                                {["Router settings and network configuration", "Network drivers and firmware updates", "Network settings reset procedures"].map((item, i) => (
                                    <div key={i} className="flex items-start">
                                        <i className="fas fa-chevron-right text-accent-teal mr-3 mt-1 text-sm"></i> <span className="text-professional-navy">{item}</span>
                                    </div>
                                ))}
                            </div>
                            <Link href="/troubleshooting" className="inline-flex items-center justify-center gap-2 w-full bg-professional-navy hover:bg-medium-blue text-white py-3 rounded-lg font-semibold smooth-transition">
                        ...
                        {/* Ink & Toner Problems */}
                        <div className="bg-white rounded-2xl p-8 card-shadow hover-lift border border-light-gray">
                            <div className="bg-accent-sage text-white w-14 h-14 rounded-full flex items-center justify-center mb-6"><i className="fas fa-tint text-xl"></i></div>
                            <h3 className="text-2xl font-bold text-professional-navy mb-4">Ink &amp; Toner Problems</h3>
                            <p className="text-medium-gray mb-6">Print quality issues, clogged nozzles, or cartridge errors? Learn proper maintenance for optimal performance.</p>
                            <div className="space-y-3 mb-8">
                            ...
                            <Link href="/troubleshooting#ink" className="inline-flex items-center justify-center gap-2 w-full bg-professional-navy hover:bg-medium-blue text-white py-3 rounded-lg font-semibold smooth-transition">
                                Solve Ink Issues →
                            </Link>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 card-shadow hover-lift border border-light-gray">
                            <div className="bg-accent-teal text-white w-14 h-14 rounded-full flex items-center justify-center mb-6"><i className="fas fa-exclamation-triangle text-xl"></i></div>
                            <h3 className="text-2xl font-bold text-professional-navy mb-4">Error Messages &amp; Codes</h3>
                            <p className="text-medium-gray mb-6">Decipher and resolve common error codes for all major printer brands. Technical fixes for frequent issues.</p>
                            <div className="space-y-3 mb-8">
                                {["Paper jam solutions and sensor resets", "Memory errors and firmware issues", "Hardware malfunction diagnostics"].map((item, i) => (
                                    <div key={i} className="flex items-start">
                                        <i className="fas fa-chevron-right text-accent-sage mr-3 mt-1 text-sm"></i> <span className="text-professional-navy">{item}</span>
                                    </div>
                                ))}
                            </div>
                            <Link href="/troubleshooting#errors" className="inline-flex items-center justify-center gap-2 w-full bg-professional-navy hover:bg-medium-blue text-white py-3 rounded-lg font-semibold smooth-transition">
                                Fix Error Codes →
                            </Link>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 card-shadow hover-lift border border-light-gray">
                            ...
                            <p className="text-medium-gray mb-6">Driver installation problems, compatibility issues, or software conflicts? Get the right drivers and instructions.</p>
                            <div className="space-y-3 mb-8">
                                {["Latest drivers for your operating system", "Clean software installation procedures", "Compatibility mode for older printers"].map((item, i) => (
                                    <div key={i} className="flex items-start">
                                        <i className="fas fa-chevron-right text-accent-teal mr-3 mt-1 text-sm"></i> <span className="text-professional-navy">{item}</span>
                                    </div>
                                ))}
                            </div>
                            <Link href="/driver-downloads" className="inline-flex items-center justify-center gap-2 w-full bg-professional-navy hover:bg-medium-blue text-white py-3 rounded-lg font-semibold smooth-transition">
                                Driver Downloads →
                            </Link>
                        </div>
                    </div>
